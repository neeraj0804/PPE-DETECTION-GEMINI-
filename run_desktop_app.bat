@echo off
echo Starting PPE Detection Desktop Application with NVIDIA GTX 1650...
echo.
...
if not exist "models\best_ppe_model.pt" (
    ...
    echo The application will still work, but will use the default YOLOv8 model.
...
echo.
echo Starting desktop application with reduced memory usage...
